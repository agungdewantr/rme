<x-report-layout :type="$type" :date="$date" :branch="$branch_id" :poli="$poli" :doctor="$doctor_id"
    :reporttypedrug="$report_type_drug" :estimatedarrival="$estimated_arrival" :is_kumulatif="$is_kumulatif">
    <div class="card">
        <div class="card-body">
            <div class="gap-2 mb-3 d-flex align-items-center">
                ...
                <div>
                    <select class="form-select @error('doctor_id') is-invalid @enderror" aria-label="Default select example" wire:model.live="estimated_arrival">
