<form wire:submit="save" class="card" x-data="registration">
    <div class="card-header d-flex justify-content-between align-items-center">
        <span>Ubah Booking</span>
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <select class="form-select @error('user_id') is-invalid @enderror" id="user_id" name="user_id"
                        aria-label="Default select example" wire:model="user_id">
                        <option value="" selected>Pilih Nama Pasien</option>
                        @foreach ($users as $u)
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <select class="form-select @error('finance_type') is-invalid @enderror" id="finance_type"
                        ...
                        <option value="" selected>Pilih Jenis Pembiayaan</option>
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" id="status"
                        name="status" aria-label="Default select example" wire:model="status" disabled>
